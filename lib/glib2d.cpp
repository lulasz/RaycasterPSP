...
void g2dInit()
{
    ...
    g2d_draw_buffer.data = (g2dColor *)vabsptr(g2d_draw_buffer.data);
    g2d_disp_buffer.data = (g2dColor *)vabsptr(g2d_disp_buffer.data);
...
void g2dFlip(g2dFlip_Mode mode)
{
    ...
    g2d_draw_buffer.data = (g2dColor *)vabsptr(sceGuSwapBuffers());
...
g2dTexture *g2dTexLoad(std::string path, g2dTex_Mode mode)
{
    g2dTexture *tex = NULL;
    FILE *fp = NULL;
    ...
    {
        unsigned char *tmp = (unsigned char *)malloc(tex->tw * tex->th * PIXEL_SIZE);
        _swizzle(tmp, (unsigned char *)tex->data, tex->tw * PIXEL_SIZE, tex->th);
        free(tex->data);
